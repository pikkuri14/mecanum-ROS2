...
def generate_launch_description():
    ...
    pkg_urdf_path = get_package_share_directory('mecanum_robot')
    pkg_gazebo_path = get_package_share_directory('mecanum_robot')
    ...
    spawn_urdf_node = Node(
        ...
        arguments=[
            ...
            '-file', urdf_file_path,
            "-x", "-1.28", "-y", "0.99", "-z", "0.5", "-Y", "-1.57"  # Initial spawn position
        ],
        output="screen",
        parameters=[
            {'use_sim_time': True},
